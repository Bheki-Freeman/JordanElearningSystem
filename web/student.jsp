        ...
        <div class="container-md col-8">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <hr>
                    <br>
                    <form action="stud_home.jsp" method="post">
                        <div class="row mb-3">
                            <label for="stud-id" class="col-sm-2 col-form-label">Student ID</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Your Student ID" id="stud-id">
                            </div>
                        </div>
                        <div class="row mb-3">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="phone" placeholder="76294516">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="inputAddress" placeholder="Your physical Address">
                        </div>

                        <div class="col-md-6">
                            <label for="inputCity" class="form-label">City</label>
                            <input type="text" class="form-control" id="inputCity" placeholder="Nhlangano">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="inputZip" placeholder="H100">
                        </div>
                        <div class="col-12">
                            <div class="form-check">
